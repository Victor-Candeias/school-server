...
export type ApplicationActions = {
  ...
  updatePercentageRange: (rangeId: string, field: "min" | "max" | "backgroundColor" | "textColor", value: string) => void
  ...
  getEvaluationMomentTypeLabel: (moment: SchoolDocument) => "Questão aula" | "Teste"
  ...
  getStudentMomentProjectedTotal: (student: SchoolDocument, moment: SchoolDocument, targetQuestion: EvaluationQuestionForm, targetValue: string) => number
  getAssessmentCellValidationError: (student: SchoolDocument, moment: SchoolDocument, question: EvaluationQuestionForm, value: string) => string | null
