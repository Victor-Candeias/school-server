...
export function AppSettingsProvider({ model, children }: AppSettingsProviderProps) {
  const value: AppSettingsContextValue = {
    ...
    popupBackgroundColor: model.popupBackgroundColor,
    setPopupBackgroundColor: model.setPopupBackgroundColor,
    popupTextColor: model.popupTextColor,
    setPopupTextColor: model.setPopupTextColor,
    errorPopupBackgroundColor: model.errorPopupBackgroundColor,
    setErrorPopupBackgroundColor: model.setErrorPopupBackgroundColor,
    errorPopupTextColor: model.errorPopupTextColor,
    setErrorPopupTextColor: model.setErrorPopupTextColor,
