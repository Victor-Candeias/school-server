...
async def find_school_test(request: Request):
...
async def findbyid_school_test(request: Request):
...
async def find_class_to_test(request: Request):
...
async def findbyid_class_to_test(request: Request):
...
async def create_evoluation_moments(request: Request):
...
async def find_evoluation_moments(request: Request):
...
async def findbyid_evoluation_moments(request: Request):
...
async def add_moments_class(request: Request):
...
async def find_moments_class(request: Request):
