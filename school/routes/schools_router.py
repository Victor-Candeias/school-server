...
# curl -X POST http://127.0.0.1:8020/schools/add -H  "Content-Type: application/json" -d "{ \"userid\": \"67e32c8bf97d9bb2e993e50d\", \"classid\": \"67e32c8bf97d9bb2e993e50d\", \"id\": \"1\", \"name\": \"nome aluno\", \"email\": \"aluno@ctt.pt\" }"
...
# curl -X GET http://127.0.0.1:8020/schools/listbyid -H  "Content-Type: application/json" -d "{ \"id\": \"67e3c8556c0e93daf9ef2d2f\" }"
